...
<script>
  ...
  edit.budgetDescriptions['-1']='<fmt:message key="description.no.budget"/>';
  edit.budgetDescriptions['-2']='<fmt:message key="description.new.budget"/>';
  ...
  edit.project = {
    id:${project.id},
    title:'${project.title}',
    begin:new Date('${project.beginDate}').toISOString().substring(0, 10),
    complete:new Date('${project.completeDate}').toISOString().substring(0, 10),
    budget:{
...
<div id="editor">
  <table>
    ...
    <tr>
      ...
      <td>
        <select id="budget" style="width: 100%" v-model="project.budget.id" :title="budgetDescriptions[project.budget.id]">
